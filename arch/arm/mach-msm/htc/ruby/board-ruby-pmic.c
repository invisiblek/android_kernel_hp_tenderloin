...
void __init ruby_gpio_mpp_init(void)
{
	...
	struct pm8xxx_gpio_init gpio_cfgs[] = {
          ...
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(RUBY_AUD_MIC_SEL),    /* 26 */
          ...
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(RUBY_AUD_HANDSET_ENO),
                           PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_NO,
                           PM8058_GPIO_VIN_L7, PM_GPIO_STRENGTH_HIGH, PM_GPIO_FUNC_NORMAL, 0, 0),
#endif
          /* CamCoder Key */
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(RUBY_GPIO_KEY_CAMCODER),
                           PM_GPIO_DIR_IN, 0, 1, PM_GPIO_PULL_UP_31P5,
                           PM8058_GPIO_VIN_S3, 0, PM_GPIO_FUNC_NORMAL, 0, 0),
          /* Cam AutoFocus key */
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(RUBY_GPIO_KEY_CAMAF),
                           PM_GPIO_DIR_IN, 0, 1, PM_GPIO_PULL_UP_1P5,
                           2, 0, PM_GPIO_FUNC_NORMAL, 0, 0),
          /* Leds */
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(RUBY_LED_3V3),
