...
static struct gpio_event_direct_entry tenderloin_keypad_input_map[] = {
	{
		.gpio = PM8058_GPIO_PM_TO_SYS(TENDERLOIN_VOL_UP),
		.code = KEY_VOLUMEUP,
	},
	{
		.gpio = PM8058_GPIO_PM_TO_SYS(TENDERLOIN_VOL_DN),
		.code = KEY_VOLUMEDOWN,
	},
};
...
/*
static int tenderloin_reset_keys_up[] = {
	KEY_VOLUMEUP,
	0
};
*/
...
static struct keyreset_platform_data tenderloin_reset_keys_pdata = {
	/* .keys_up = tenderloin_reset_keys_up, */
	.keys_down = {
		KEY_POWER,
		KEY_VOLUMEDOWN,
		KEY_VOLUMEUP,
