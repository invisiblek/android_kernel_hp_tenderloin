...
#define MSM_TRIG_A2M_SMD_INT   (writel(1 << 0, MSM_APCS_GCC_BASE + 0x8))
#define MSM_TRIG_A2Q6_SMD_INT  (writel(1 << 8, MSM_APCS_GCC_BASE + 0x8))
#define MSM_TRIG_A2M_SMSM_INT  (writel(1 << 5, MSM_APCS_GCC_BASE + 0x8))
#define MSM_TRIG_A2Q6_SMSM_INT (writel(1 << 8, MSM_APCS_GCC_BASE + 0x8))
